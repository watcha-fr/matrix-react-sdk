...
class InviteMemberDialog extends Component {
    ...
    onSearch = value => {
        this._doUserDirectorySearch(value);
    };
    ...
    // TODO: check if getUsers() is still unreliable
    //       not all users appear according to context
    //       ie: who does the search, new user, user who has never been invited
    ...
    _doUserDirectorySearch(query) {
        ...
        MatrixClientPeg.get()
            ...
            .catch(err => {
                ...
                this.setState({ searchError: err.errcode ? err.message : _t("Something went wrong!") });
    ...
    _startDm = async () => {
        ...
        const createRoomOptions = { inlineErrors: true }; // XXX: Type out `createRoomOptions`
