...
export default createReactClass({
    ...
    componentDidMount() {
        ...
        // insertion for watcha
        cli.getProfileInfo(this.props.member.userId)
    ...
    _getDisplayName: function() {
        // added for watcha op277
        const user = this.props.member;
        if (user.needsDisplayNameDisambiguation) {
            return user.name.replace(user.userId, this.state.email);
        }
        // end added for watcha op277
    ...
    render: function() {
        ...
        const av = (
            // change for watcha: add email as title
            <MemberAvatar member={member} title={this.state.email} width={36} height={36} aria-hidden="true" />
            // end of change
        );
        ...
        return (
            <EntityTile
                ...
                avatarJsx={av}
                // change for watcha
                title={this.state.email || member.userId}
                // end of change
                name={name}
