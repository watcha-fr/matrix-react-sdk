        ...
        return (
            <div className="mx_GeneralUserSettingsTab_section--discovery_existing">
                ...
                <AccessibleButton disabled={SettingsStore.getValue(UIFeature.watcha_SitivFieldDisabled)} // watcha++
                                  onClick={this.onRemove} kind="danger_sm" disabled={this.props.disabled}>
                    {_t("action|remove")}
                </AccessibleButton>
            </div>
        );
...
export default class EmailAddresses extends React.Component<IProps, IState> {
    ...
    public render(): React.ReactNode {
        ...
        let addButton = (
            <AccessibleButton disabled={SettingsStore.getValue(UIFeature.watcha_SitivFieldDisabled)} // watcha++
                              onClick={this.onAddClick} kind="primary" disabled={this.props.disabled}>
                {_t("action|add")}
            </AccessibleButton>
        );
            ...
            <>
                ...
                <form onSubmit={this.onAddClick} autoComplete="off" noValidate={true}>
                    <Field
                        ...
                        autoComplete="email"
                        disabled={this.props.disabled || this.state.verifying || SettingsStore.getValue(UIFeature.watcha_SitivFieldDisabled)} // watcha++
